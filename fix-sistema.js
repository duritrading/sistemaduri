// fix-sistema.js - CORREÇÃO AUTOMATIZADA
// Execute na raiz do projeto: node fix-sistema.js
...
// 3. LIMPAR E RECRIAR .env.local
console.log('\n3️⃣ LIMPANDO E RECRIANDO .env.local...');
...
// Criar novo .env.local limpo
const newEnvContent = `# CONFIGURAÇÃO SUPABASE - SISTEMA DURI
...
console.log('\n7️⃣ CRIANDO TESTE DE CONEXÃO...');

const testConnectionCode = `// test-connection.js - TESTE DE CONEXÃO SUPABASE
...
console.log('==========================================');node diagnose-sistema.js && node fix-sistema.js && npm run dev