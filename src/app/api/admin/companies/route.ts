// src/app/api/admin/companies/route.ts - FIXED: NO INTERNAL FETCH
...
export async function GET() {
  try {
    console.log('🔍 [API] Admin solicitando lista de empresas...');

    // ✅ Import direto do Supabase - SEM fetch interno
    ...
    // ✅ Buscar empresas diretamente do Supabase
